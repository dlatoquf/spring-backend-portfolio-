...
> 관리자 데이터를 효율적으로 관리하기 위한 웹 기반 시스템 (End-to-End 개발)
...
## 📌 프로젝트 소개
영업점의 기본 정보를 등록, 수정, 조회할 수 있는 웹 기반 관리 시스템입니다.  
...
👉 사용자 화면부터 데이터 처리, 서버 운영까지 전 과정을 경험할 수 있었습니다.  

특히 Excel 대량 데이터 처리 과정에서  
데이터 검증과 정합성 유지의 중요성을 체감할 수 있었으며,  

Linux 환경에서 직접 배포 및 유지보수를 경험하며  
실제 서비스 운영에 필요한 역량을 키울 수 있었습니다.
